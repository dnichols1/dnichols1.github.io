...
In particular, the dark matter adds an additional drag force that causes the small black hole or neutron star to inspiral much more rapidly than it would if gravitational waves were the only source of energy loss from the system.
...
In the first paper, however, we noted that previous estimates of the change in the rate of inspiral assumed that the distribution of dark matter was static throughout the process.
...
In the second (more recent) paper, we addressed this question about the possibilities for detecting, discovering, and measuring the presence of dark matter in these IMRI systems.
