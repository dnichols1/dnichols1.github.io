...
[arXiv:2508.21132](https://doi.org/10.48550/arXiv.2508.21132).
...
[arXiv:2409.10846](https://doi.org/10.48550/arXiv.2409.10846).
...
[arXiv:2309.06498](https://doi.org/10.48550/arXiv.2309.06498).
...
[arXiv:2108.04154](https://doi.org/10.48550/arXiv.2108.04154).
...
[arXiv:2002.12811](https://doi.org/10.48550/arXiv.2002.12811).
...
In the fifth paper (Wade and Nichols), we looked into the effect of different initial data on the dark matter effects on the binary's orbit and the emitted gravitational waves.
...
In the most recent paper (Wade, Heeck, and Nichols), we investigated neutron-star secondaries again (as in the earliest two papers), but here we assumed that the dark matter could interact with itself (self-annihilation) or with the neutron-rich matter in the neutron star.
Having dark-matter self-annihilation changed the structure of the dark matter distribution closest to the massive black hole (where it decreased the density compared to non-interacting dark matter).
Introducing interactions between the dark matter and neutron-star matter permitted accretion of dark matter onto the neutron star (and in cases with dark-matter self-annihilation, the loss of the accreted mass from the neutron star).
We investigated the effects of the different density and the accretion (and subsequent mass loss from the neutron star) on the orbit of the neutron star and the emitted gravitational waves.
We were able to identify scenarios in which these signatures of dark-matter self-annihilations or interactions of dark matter and neutron-star matter were large enough to have a measurable impact on the gravitational waves that the LISA mission could measure from these systems.
